...
function startgame(){
  game_status = "start"
  document.getElementById('status').innerHTML = "Game loadin"
}
...
function game() {
  ...
  if (gameConfig.status === 'start') {
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Any play button nose to Start and Play ", gameConfig.screenX / 2, gameConfig.screenY / 2);
    textSize(40);
...
function changeGameStatud(character) {
  if (game_status == "start"  && noX !="" &&  gameConfig.status === "start") {
    console.log("hgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghh")
    world_start.play();
    console.log("hgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghhhgvgfghfvhgfngfb g vfvgfgmnghh")
...
function jumping(character) {
  if (( noY < 200 && character.live) || (touchIsDown && character.live)) {
    mario_jump.play()
